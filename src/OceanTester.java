...
public class OceanTester extends AssignmentTester{
	...
	protected AssignmentTestCase[] getCases()
	{
		...
		tests[14] = new OceanTestCase(buildFleet(new int[] {185, 373, 638, 459, 998, 5, 295, 609, 539, 856}),new Position[] {p[0][4],p[0][5],p[0][6],p[0][7],p[0][8],p[0][9],p[3][8],p[3][9],p[5][9],p[5][8],p[5][7],p[5][6],p[5][5],p[9][0],p[9][1],p[9][2],p[9][3],p[9][4],p[9][5],p[9][6],p[9][7],p[9][8],p[7][3],p[2][4]});
